 ...
 *     }
 * )
 * @ApiFilter(SearchFilter::class, properties={"amount", "sentAt"})
 */
class Invoice
{
    /**
     ...
     * @Assert\Type(type="numeric", message="Le montant de la facture doit être un numéric !")
     */
    private $amount;
     ...
     * @Assert\DateTime(message="La date doit être renseignée au format YYYY-MM-DD")
     */
    private $sentAt;
    ...
    /**
     * Permet de récupérer le user d'une facture
     *
     * @return User
